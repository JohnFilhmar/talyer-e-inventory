...
import { registerSchema, type RegisterFormData } from '@/utils/validators/auth';

/**
 * Customer Registration page component
 * 
 * Features:
 * - Customer registration with name, email, password
 * - Form validation with Zod
 * - Password strength requirements
 * - Error handling and display
 * - Redirect to dashboard after registration
 * - No branch required - customers can shop from any branch
 */
export default function RegisterForm() {
  const router = useRouter();
  const { register: registerCustomer, isLoading, error, clearError, isAuthenticated, isInitialized } = useAuth();
